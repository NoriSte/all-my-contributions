...
- Frontend Platform use case - Acting before a real Product need ([dev.to](https://dev.to/noriste/frontend-platform-use-case-acting-before-a-real-product-need-c38)) - ⭐️ *Featured on [dev.to Top 7 Featured DEV Posts from the Past Week](https://dev.to/devteam/top-7-featured-dev-posts-from-the-past-week-34h0)*
