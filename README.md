...
- Frontend Platform use case - Enabling features and hiding the distribution problems, May 2023 ([dev.to](https://dev.to/noriste/frontend-platform-use-case-enabling-features-and-hiding-the-distribution-problems-12mi))
- Frontend Platform use case - Creating a roadmap without a Product Manager, May 2023 ([dev.to](https://dev.to/noriste/frontend-platform-use-case-creating-a-roadmap-without-a-product-manager-2fdd))
