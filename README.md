...
- August, 2024 - Javascript Testing, a Practical Approach @ [Banca CF+](https://www.bancacfplus.it/)
...
([dev.to](https://dev.to/noriste/production-grade-gradient-bordered-transparent-and-rounded-button-56h4))
...
**Design System Visual Coverage**
- Mar, 2026 - [WebDay](https://www.webdayconf.it/2026) ([Recording](https://www.improove.tech/app/videos/5119/How-to-track-and-guide-the-Design-System-adoption-in-React-and-React-Native) - [Slides](https://noriste.github.io/design-system-coverage-webday-2026/1))
...
- Feb, 2025 - Commit to Growth  ([Podcast](https://podcasts.apple.com/it/podcast/commit-to-growth/id1788326535) - [Recording](https://podcasts.apple.com/us/podcast/lessons-from-large-codebases-design-visual-coverage/id1788326535?i=1000688799413))
...
- Feb, 2023 - Continuous Testing Meetup Berlin ([Slides](https://slides.com/noriste/hasuras-console-e2e-tests-chronicles) - [Recording](https://app.livestorm.co/educativeinc/optimizing-large-codebases-lessons-learned-scaling-internet-scale-frontends/live#/) - [Related article](https://dev.to/noriste/hasura-e2e-tests-chronicles-february-2023-24ki))
...
| Activity                                                                                                                                                                                                                         | What I did                                                                                             |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Talk: [Front-end testing at Preply: Shifting left towards component testing with Storybook](https://www.meetup.com/reactjs-barcelona/events/313957418/?eventOrigin=group_past_events).                                           | I encourages Dominika and Lukasz to jump on the stage, helped them with the dry-runs and storytelling. |
| Article: [How Preply reduced costs by 46% before scaling LLM features](https://medium.com/preply-engineering/how-preply-reduced-costs-by-46-before-scaling-llm-features-27a2c0b5af1d).                                           | I proposed Sviatoslav to write the article, and reviewed it.                                           |
| Article: [Front-end testing at Preply: shifting left towards component testing](https://medium.com/preply-engineering/front-end-testing-at-preply-shifting-left-towards-component-testing-3e83c8608235).                         | I pushed Dominika and Lukasz, helped during the writing phase, and constantly reviewed the article.    |
